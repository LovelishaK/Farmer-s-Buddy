<?php
	...
	$displayImages = null;
	   $sqlSelProd =mysqli_query($bd,"select * from product where pro_cat='Guide'") or die(mysql_error());
    ...
    <div class="breadcrumbs">
        <div class="container">
            <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                ...
                <li class="active">Farming Guide</li>
            </ol>
        </div>
    </div>
<div class="products">
 ...
 <?php include("footer.php") ?>   <?php
	...
	//include("Admin/Functions.php");
	$displayImages = null;
	   $sqlSelProd = mysql_query("select * from product where pro_cat='Cat'") or die(mysql_error());
