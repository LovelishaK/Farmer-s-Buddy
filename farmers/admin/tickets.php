  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">Registered Services</h1>
                    <ul class="breadcrumb">
...
<table class="table">
  ...
  <table class="table">
    ...
    <?php
    include('config.php');
    $result = mysqli_query($bd,"SELECT * FROM orderdetails where status=''");
    ...
    <tr class="<?php echo $class; ?>" style="height:25px;">
      ...
      <td align="center"><a href="viewtickets.php?custID=<?php echo $orderno; ?>">View</a></td>
    </tr>
    <?php
	} // end while
	?>
