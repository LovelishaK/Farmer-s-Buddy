...
$cid = $_GET['custID'];
//echo $cid;
$sql= "Select * from sell where Status='Posted' and id = '$cid'";
$result = mysqli_query($bd,$sql);
while($data = mysqli_fetch_array($result)){
extract($data);

?>  
<form action="edit.php?action=editsell" method="post"  name="frmListUser" id="frmListUser">
                <h3 style="text-decoration:underline">Crop Details</h3>
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 75%;"><div class="form-group">
                    <label>Crop Name</label>
                    <input type="text" class="form-control span12" readonly="true"  id="CustomerName"  name="CustomerName"  value="<?php echo $crops; ?>">
                </div>
                <div class="form-group">
                    <label>Weight</label>
                    <input type="text" class="form-control span12" readonly="true" name="areaname"  id="areaname" value="<?php echo $weight; ?>">
                </div>
                <div class="form-group">
                    <label>Expected Price</label>
                    <input type="text" class="form-control span12" readonly="true" name="areaname"  id="areaname" value="<?php echo $eprice; ?>">
                </div></td>
