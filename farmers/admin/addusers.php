  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">Add - User Details</h1>
                    <ul class="breadcrumb">
...
<form action="insuser.php" method="post" enctype="multipart/form-data" name="addroom">
                <div class="form-group">
                    <label>User Full Name</label>
                    <input type="text" class="form-control span12"  id="userfullname"  name="userfullname" required >
                </div>
                <div class="form-group">
                    <label>Username</label>
                    <input type="text" class="form-control span12" name="username"  id="username" required>
                </div>
                <div class="form-group">
