...
?>  
<form action="edit.php?action=edituser" method="post"  name="frmListUser" id="frmListUser">
            <input type="text" name="txtid" value="<?php echo $id; ?>" />
                <div class="form-group">
                    <label>Full Name</label>
                    <input type="text" class="form-control span12"  id="fullname"  name="fullname"  value="<?php echo $userFullName; ?>">
                </div>
                <div class="form-group">
                    <label>Username</label>
                    <input type="text" class="form-control span12"  id="username"  name="username"  value="<?php echo $username; ?>">
                </div>
                <div class="form-group">
                    <label>Pssword</label>
                    <input type="password" class="form-control span12"  id="password"  name="password"  value="<?php echo $password; ?>">
                </div>
                <input type="text" class="form-control span12"  id="userid"  name="userid" style="display:none"  value="<?php echo $userID; ?>">
