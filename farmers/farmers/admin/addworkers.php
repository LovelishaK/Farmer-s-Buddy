  ...
  <?php   include('head.php');   ?>
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">Add - Workers Details</h1>
                    <ul class="breadcrumb">
...
<form action="insworker.php" method="post" enctype="multipart/form-data" name="addroom">
                ...
                <div class="form-group">
                    <label>Phone</label>
                    <input type="number" class="form-control span12" name="phone"  id="phone" required>
                </div>
                <div class="form-group">
                    <label>Address</label>
                    <input type="text" class="form-control span12"  id="userfullname"  name="address" required >
                </div>
                 <div class="form-group">
